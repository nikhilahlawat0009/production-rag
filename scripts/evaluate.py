...
# Reuse the same example corpus from the API startup.
DOCUMENTS = [
...
CONFIGURATIONS = {
    "semantic_only": {"bm25": 0.0, "semantic": 1.0, "rerank": 0.0},
    "hybrid": {"bm25": 0.5, "semantic": 0.5, "rerank": 0.0},
    "hybrid_rerank": {"bm25": 0.3, "semantic": 0.4, "rerank": 0.3}
}
...
def evaluate(retriever: HybridRetriever, eval_data: List[Dict[str, Any]], config_name: str, weights: Dict[str, float]) -> Dict[str, Any]:
    ...
    for item in eval_data:
        ...
        # Warm fetch immediately after first call
        start = time.time()
    ...
    return {
        ...
        "cold_p95_ms": statistics.quantiles(cold_latencies, n=20)[-1],
...
if __name__ == "__main__":
    ...
    print("Running evaluation over configurations...")
